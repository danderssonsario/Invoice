...
const [formData, setFormData] = useState(initState)
  ...
  const { items, order, issuer, customer, payment } = formData
 ...
 const sendInvoice = () => {
  ...
  useEffect(() => {
    ...
    dispatch(resetState())
  }, [user, isError, isSuccess, message, navigate, dispatch, draft])
          ...
          <div className='flex flex-col mx-auto pb-20'>
            ...
            <div className='flex flex-col mx-auto bg-white p-5 rounded-b'>
              <div className='p-5'>
                ...
                <div className='flex text-lg items-start w-full mb-0 bg-gray-100'>
                ...
                {items.map((item, index) => (
                  <div key={index} className='min-w-full'>
                    <div className='text-lg flex items-start min-w-full relative'>
                      <div>
                      ...
                      <p className='mt-2 p-1'>{item.priceTotal}ok</p>
                    </div>
                  </div>
                ))}
